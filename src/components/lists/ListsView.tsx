...
export function ListsView({ viewMode, homeTourSteps, showTutorial = true, inviteToken = null, onInviteHandled, selectedLabel = 'Any', onLabelsChange }: ListsViewProps) {
              ...
              <div className="space-y-2">
                {activeLists.map(list => (
                  <SortableListCard
                    ...
                    onDuplicate={(id, name) => duplicateList(id, name, lists.find(l => l.id === id)?.label || undefined)}
                    onLeave={leaveList}
                    onRefresh={refresh}
                    labels={labels}
