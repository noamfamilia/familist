 ...
 * Portaled to `document.body`. Mobile: edge-to-edge with a single vertical scrollport; horizontal
 * pan is delegated to the list table zone inside `ListDetailView`. `sm+`: dimmed backdrop; list
 * shell centered on the x-axis and aligned to the top; backdrop scrolls vertically when content is tall.
 *
