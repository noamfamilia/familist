  ...
  return (
    ...
    >
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
        Sign out once, then open from the profile menu (below User feedback). Look for{' '}
        <code className="text-teal">selectorDirectMismatch: true</code> on <code className="text-teal">useLists:return</code>{' '}
        after <code className="text-teal">beginHomeSession</code> — selected should match direct (guest, 2 lists, loading false).
      </p>
