/**
 * Connectivity indicator — geometry from repo root `offline2.svg` (SVG Repo), cyan fill.
 * `offline`: cloud with ✕; `recovering`: cloud only (reconnecting).
 */
...
export function OfflineIcon({
  ...
  return (
    ...
    >
      ...
      {variant === 'offline' ? <path d={OFFLINE2_X_D} fill="currentColor" /> : null}
    </svg>
  )
}
