/**
 * Offline indicator — geometry from repo root `offline2.svg` (SVG Repo), cyan outline.
 */
const OFFLINE2_PATH_D =
...
export function OfflineIcon({ className = 'h-8 w-8' }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d={OFFLINE2_PATH_D} fill="currentColor" />
    </svg>
  )
}
