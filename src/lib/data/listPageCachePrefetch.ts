...
/**
 * Hydrate localStorage list-detail cache (L1) from Dexie (L2) before opening list detail (`/?list=` or `/list/[id]`).
...
/**
 * L1 localStorage + Zustand session warm before `router.push` so list detail can render without a loading gate.
 */
