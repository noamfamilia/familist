...
export const ITEM_CATEGORY_STYLES: Record<ItemCategory, { shell: string; swatch: string; modal: string }> = {
  1: {
    shell: 'bg-gray-50 hover:bg-gray-100 dark:bg-slate-800 dark:hover:bg-slate-700',
    swatch: 'border border-gray-300 bg-gray-50 dark:border-slate-500 dark:bg-slate-800',
    modal: 'bg-gray-100 border border-gray-300 dark:bg-slate-800 dark:border-slate-600',
  },
  2: {
